...
-- ----------------------------
INSERT INTO `seckill_goods` VALUES (1, 1, 0.01, 10, '2021-08-27 17:17:53', '2021-09-02 17:17:53');
INSERT INTO `seckill_goods` VALUES (2, 2, 0.01, 10, '2021-05-25 17:17:53', '2021-05-26 17:17:53');
INSERT INTO `seckill_goods` VALUES (3, 3, 0.01, 10, '2021-05-25 17:17:53', '2021-05-26 17:17:53');
INSERT INTO `seckill_goods` VALUES (4, 4, 0.01, 10, '2021-05-25 17:17:53', '2021-08-29 17:17:53');
...
CREATE TABLE `user`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键编号,用户id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '秒杀用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (2, 15847289590, 'Noodle', 'b7797cce01b4b131b433b6acf4add449', '1a2b3c4d', NULL, NULL, NULL, 0);
